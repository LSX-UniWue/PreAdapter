...
def asc_config(parser):
    parser.add_argument('--backbone', default='', type=str, required=True,
                        ...
                        choices=['bert', 'bert_frozen', 'bert_adapter', 'w2v_as', 'w2v', 'cnn', 'mlp', 'roberta', 'roberta_adapter'])
    ...
    parser.add_argument('--baseline', default='', type=str, required=True,
                        ...
                        choices=['ncl', 'one', 'mtl', 'l2', 'a-gem', 'derpp', 'kan', 'srk', 'ewc', 'hal', 'ucl', 'owm',
                                 'acl', 'hat', 'cat', 'b-cl', 'classic', 'ctr', 'ctr_kg',
                                 'one_mlm', 'ctr_kg_qa_dragon','one_qa_dragon'])
    parser.add_argument('--task', default='qa_dragon', type=str, help='what datasets',
                        choices=['asc', 'dsc', 'vlcs', 'cifar10', 'mnist', 'fashionmnist', 'cifar100', 'asc_2', 'asc_5',
                                 'qa_dragon'])
    parser.add_argument('--scenario', default='til_classification', type=str, required=True, help='what senario it will be',
                        choices=['til_classification', 'dil_classification']
                        )
    parser.add_argument('--selectgpu', default='0', type=str, required=False, help='(default=%(default)s)')
    ...
    parser.add_argument('--ntasks', default=2, type=int, required=False, help='(default=%(default)d)')
    ...
    parser.add_argument('--mylamb', default=0.01, type=float, required=False,
                        help='(default=%(default)f)')
    ...
    parser.add_argument('--bert_adapter_size', default=2000, type=int, required=False,
                        help='(default=%(default)d)')
    parser.add_argument('--roberta_adapter_size', default=256, type=int, required=False,
                        help='(default=%(default)d)')
    parser.add_argument('--graph_run', default='', type=str, help='best or last graph  model to use',
                        choices=['best', 'last'])
    ...
    parser.add_argument('--apply_roberta_output', action='store_true')
    parser.add_argument('--apply_bart_output', action='store_true')
    parser.add_argument('--apply_bert_attention_output', action='store_true')
    parser.add_argument('--apply_roberta_attention_output', action='store_true')
    parser.add_argument('--apply_bart_attention_output', action='store_true')
    ...
    parser.add_argument('--unfreez', action='store_true')  # for training model with adapters
    parser.add_argument('--auto_resume', action='store_true')
    parser.add_argument('--eval_forward', action='store_true')
    parser.add_argument('--subject_only', action='store_true')
    parser.add_argument('--log_pred', action='store_true')
    parser.add_argument("--yaml_param_num", default='', type=str)
    parser.add_argument("--model_save_path", default='', type=str)
    parser.add_argument("--path_to_model_to_eval", default='', type=str)
    parser.add_argument("--trained_model_path", default='', type=str)
    parser.add_argument("--akbc_test_name", default='TREx', type=str)
    parser.add_argument("--load_trained_capsule_model",
                        action='store_true')
    parser.add_argument("--mini_batch_size", default=2, type=int)
    parser.add_argument("--mini_batch_size_graph", default=100, type=int)
    parser.add_argument("--num_train_epochs_qa", default=100, type=int)
    parser.add_argument("--max_epochs_before_stop_graph", default=4, type=int)
    parser.add_argument("--max_epochs_before_stop", default=4, type=int)
    parser.add_argument("--encoder_lr", default=1e-5, type=float)
    parser.add_argument("--reuse_data",
                        action='store_false')
    parser.add_argument("--triple_representation", default='natural', type=str, choices=['triple', 'words', 'natural'])
    return parser
...
def train_config(parser):
    ...
    parser.add_argument("--roberta_hidden_size", default=1024, type=int)
...
def ucl_config(parser):
    ...
    parser.add_argument('--smax', default=400, type=float,
                        help='(default=%(default)f)')  # s for limiting task embeddings
...
def contrastive_config(parser):
    ...
    parser.add_argument('--n_data', type=int, default=1000,
                        help=' the number of samples in the training set, therefor the memory buffer is: opt.n_data x opt.feat_dim')
